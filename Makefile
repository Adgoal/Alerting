...
.PHONY: stop
stop: ## build environment and initialize composer and project dependencies
	docker-compose down
...
static-analysis: style layer coding-standards ## Run phpstan, deptrac, easycoding standarts code static analysis
